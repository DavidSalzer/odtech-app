    ...
    return {
        ...
        link: function (scope, el, attrs) {
            ...
            $timeout(function () {
                ...
                scope.subdestinationMarkerIcon = scope.missionData.invisibleTarget ? { url: './img/transparent.png', scaledSize: new google.maps.Size(1, 1)} : { url: './img/mapDisPoint.png', scaledSize: new google.maps.Size(38, 53) };
                scope.destinationMarkerIcon = scope.missionData.invisibleTarget ? { url: './img/transparent.png', scaledSize: new google.maps.Size(1, 1)} : { url: './img/mapDisPoint.png', scaledSize: new google.maps.Size(38, 53) };
