    ...
    */
    ...
    return {
        ...
        captureImage: function (_photoClicked) { // take photo
            ...
            navigator.nativeCamera.getPicture(onImageSuccess, onFail, //take photo options and use plugin
                {
                quality: 85,
                destinationType: navigator.nativeCamera.DestinationType.FILE_URI,
                //  targetWidth: 584,
                correctOrientation: true,
                saveToPhotoAlbum: true,
                 mediaType: navigator.nativeCamera.MediaType.PICTURE,
                 encodingType: navigator.nativeCamera.EncodingType.JPEG
        ...
        var fail = function (message) {
            $rootScope.$apply(function () {
                deferred.reject(message);
                             ...
                             defaultOptions = {
                             quality: 85,
                             //sourceType: navigator.nativeCamera.PictureSourceType.PHOTOLIBRARY,
                             destinationType: navigator.camera.DestinationType.FILE_URI,
                             ...
                             navigator.nativeCamera.getPicture(success, fail, options);
