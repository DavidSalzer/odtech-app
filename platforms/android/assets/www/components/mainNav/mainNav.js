odtechApp.controller('mainNav', ['$rootScope', '$scope', '$state', 'missions', '$timeout', 'server', 'camera', '$stateParams','localize', function ($rootScope, $scope, $state, missions, $timeout, server, camera, $stateParams,localize) {
