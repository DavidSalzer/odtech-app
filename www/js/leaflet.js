...
! function (t, e, i) {
    var n = t.L,
        o = {};
    o.version = "0.6", "object" == typeof module && "object" == typeof module.exports ? module.exports = o : "function" == typeof define && define.amd && define(o), o.noConflict = function () {
        return t.L = n, this
    }, t.L = o, o.Util = {
        extend: function (t) {
    ...
    function () {
        var i = o.DomUtil.testProp(["userSelect", "WebkitUserSelect", "OUserSelect", "MozUserSelect", "msUserSelect"]),
            n = o.DomUtil.testProp(["userDrag", "WebkitUserDrag", "OUserDrag", "MozUserDrag", "msUserDrag"]);
        o.extend(o.DomUtil, {
            disableTextSelection: function () {
                if (i) {
                    var n = e.documentElement.style;
                    this._userSelect = n[i], n[i] = "none"
                } else o.DomEvent.on(t, "selectstart", o.DomEvent.stop)
            },
            enableTextSelection: function () {
                i ? (e.documentElement.style[i] = this._userSelect, delete this._userSelect) : o.DomEvent.off(t, "selectstart", o.DomEvent.stop)
            },
            disableImageDrag: function () {
                if (n) {
                    var i = e.documentElement.style;
                    this._userDrag = i[n], i[n] = "none"
                } else o.DomEvent.on(t, "dragstart", o.DomEvent.stop)
            },
            enableImageDrag: function () {
                n ? (e.documentElement.style[n] = this._userDrag, delete this._userDrag) : o.DomEvent.off(t, "dragstart", o.DomEvent.stop)
            }
        })
        ...
        removeLayer: function (t) {
            ...
            if (this._layers[e]) return this._loaded && (t.onRemove(this), this.fire("layerremove", {
                layer: t
            })), delete this._layers[e], this._zoomBoundLayers[e] && (delete this._zoomBoundLayers[e], this._updateZoomLevels()), this.options.zoomAnimation && o.TileLayer && t instanceof o.TileLayer && (this._tileLayersNum--, this._tileLayersToLoad--, t.off("load", this._onTileLayerLoad, this)), this
        },
        hasLayer: function (t) {
        ...
        unproject: function (t) {
            for (var e, i = o.LatLng.RAD_TO_DEG, n = this.R_MAJOR, s = this.R_MINOR, a = t.x * i / n, r = s / n, h = Math.sqrt(1 - r * r), l = Math.exp(-t.y / s), u = Math.PI / 2 - 2 * Math.atan(l), c = 15, d = 1e-7, p = c, _ = .1; Math.abs(_) > d && --p > 0;) e = h * Math.sin(u), _ = Math.PI / 2 - 2 * Math.atan(l * Math.pow((1 - e) / (1 + e), .5 * h)) - u, u += _;
        ...
        _initContainer: function () {
            ...
            if (!this._container) {
                if (this._container = o.DomUtil.create("div", "leaflet-layer"), this._updateZIndex(), this._animated) {
                    ...
                    this._bgBuffer = o.DomUtil.create("div", e, this._container), this._bgBuffer.style.zIndex = 1, this._tileContainer = o.DomUtil.create("div", e, this._container), this._tileContainer.style.zIndex = 2
    ...
    function () {
        ...
        addData: function (t) {
            ...
            if (!s.filter || s.filter(t)) {
                var a = o.GeoJSON.geometryToLayer(t, s.pointToLayer, s.coordsToLatLng);
    ...
    function () {
        ...
        WHEEL: "onwheel" in e ? "wheel" : "onmousewheel" in e ? "mousewheel" : "MozMousePixelScroll",
        addListener: function (t, e, i, n) {
            var s, a, r, h = o.stamp(i),
                l = "_leaflet_" + e + h;
            return t[l] ? this : (s = function (e) {
                return i.call(n || t, e || o.DomEvent._getEvent())
            }, o.Browser.msTouch && 0 === e.indexOf("touch") ? this.addMsTouchListener(t, e, s, h) : (o.Browser.touch && "dblclick" === e && this.addDoubleTapListener && this.addDoubleTapListener(t, s, h), ("wheel" === e || "mousewheel" === e) && (e = o.DomEvent.WHEEL), "addEventListener" in t ? "mouseenter" === e || "mouseleave" === e ? (a = s, r = "mouseenter" === e ? "mouseover" : "mouseout", s = function (e) {
        ...
        getMousePosition: function (t, i) {
            var n = e.body,
                s = e.documentElement,
                a = t.pageX ? t.pageX : t.clientX + n.scrollLeft + s.scrollLeft,
                r = t.pageY ? t.pageY : t.clientY + n.scrollTop + s.scrollTop,
                h = new o.Point(a, r);
            return i ? h._subtract(o.DomUtil.getViewportOffset(i)) : h
        },
        getWheelDelta: function (t) {
            var e = 0;
            return "wheel" === t.type ? e = -t.deltaY / (t.deltaMode ? 1 : 120) : "mousewheel" === t.type ? e = t.wheelDelta / 120 : "MozMousePixelScroll" === t.type && (e = -t.detail), e
        },
        ...
        _onUp: function () {
            o.Browser.touch || (o.DomUtil.enableTextSelection(), o.DomUtil.removeClass(e.body, "leaflet-dragging"));
            for (var t in o.Draggable.MOVE) o.DomEvent.off(e, o.Draggable.MOVE[t], this._onMove).off(e, o.Draggable.END[t], this._onUp);
            o.DomUtil.enableImageDrag(), this._moved && (o.Util.cancelAnimFrame(this._animRequest), this.fire("dragend")), this._moving = !1
        }
        ...
        addHooks: function () {
            o.DomEvent.on(this._map._container, "wheel", this._onWheelScroll, this), this._delta = 0
        },
        removeHooks: function () {
            o.DomEvent.off(this._map._container, "wheel", this._onWheelScroll)
        },
        ...
        _initLayout: function () {
            ...
            e.setAttribute("aria-haspopup", !0), o.Browser.touch ? o.DomEvent.on(e, "click", o.DomEvent.stopPropagation) : (o.DomEvent.disableClickPropagation(e), o.DomEvent.on(e, "wheel", o.DomEvent.stopPropagation));
        ...
        _getPos: function () {
            ...
            return o.Browser.any3d ? (n = a[o.DomUtil.TRANSFORM].match(this._transformRe), e = n ? parseFloat(n[1]) : 0, i = n ? parseFloat(n[2]) : 0) : (e = parseFloat(a.left), i = parseFloat(a.top)), new o.Point(e, i, !0)
        },
        ...
        _animateZoom: function (t) {
            ...
            var i = this._bgBuffer;
            e && (clearTimeout(this._clearBgBufferTimer), o.Util.falseFn(i.offsetWidth));
            var n = o.DomUtil.TRANSFORM,
                s = t.delta ? o.DomUtil.getTranslateString(t.delta) : i.style[n],
                a = o.DomUtil.getScaleString(t.scale, t.origin);
            i.style[n] = t.backwards ? a + " " + s : s + " " + a
        },
        ...
        _prepareBgBuffer: function () {
            ...
            return e && i > .5 && .5 > n ? (t.style.visibility = "hidden", this._stopLoadingImages(t), void 0) : (e.style.visibility = "hidden", e.style[o.DomUtil.TRANSFORM] = "", this._tileContainer = e, e = this._bgBuffer = t, this._stopLoadingImages(e), void 0)
        },
